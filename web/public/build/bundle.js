...
var app = (function () {
    ...
    const file$8 = "src\\Component\\Box.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 4, 0, 49);
    		},
    ...
    class Box extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { darkMode: 0 });
    ...
    const file$7 = "src\\Stages\\AddBet.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file$7, 28, 4, 806);
    			option0.__value = "auto";
    			option0.value = option0.__value;
    			add_location(option0, file$7, 30, 8, 903);
    ...
    class AddBet extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { darkMode: 0, generalId: 5 });
    ...
    const file$6 = "src\\Stages\\ManualBet.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input0.required = true;
    			toggle_class(input0, "dark", /*darkMode*/ ctx[0]);
    			add_location(input0, file$6, 45, 8, 1183);
    			attr_dev(input1, "type", "number");
    			...
    			input1.required = true;
    			toggle_class(input1, "dark", /*darkMode*/ ctx[0]);
    			add_location(input1, file$6, 46, 8, 1306);
    			...
    			add_location(input2, file$6, 47, 8, 1429);
    			...
    			add_location(input3, file$6, 48, 8, 1552);
    			...
    			add_location(input4, file$6, 49, 8, 1675);
    			attr_dev(div, "class", "grid svelte-14lmu5h");
    			add_location(div, file$6, 44, 4, 1155);
    			attr_dev(button, "class", "svelte-14lmu5h");
    			toggle_class(button, "dark", /*darkMode*/ ctx[0]);
    			add_location(button, file$6, 52, 4, 1808);
    			add_location(form, file$6, 39, 0, 945);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (darkMode === undefined && !('darkMode' in $$props || $$self.$$.bound[$$self.$$.props['darkMode']])) {
    			console_1.warn("<ManualBet> was created without expected prop 'darkMode'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<ManualBet> was created with unknown prop '${key}'`);
    	});
    ...
    const file$5 = "src\\Stages\\Menu.svelte";
    ...
    const file$4 = "src\\Stages\\StartDraw.svelte";
    ...
    const file$2 = "src\\AddGhost.svelte";
    ...
    function create_if_block_9(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode*/ 524352) {
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, generalId*/ 524354) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    ...
    function create_if_block_6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(110:2) {#if currStage === \\\"manual\\\"}",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, currStage*/ 524384) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(116:2) {#if currStage === \\\"betDone\\\"}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, allBets, nBet*/ 524364) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(123:2) {#if currStage === \\\"draw\\\"}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, winners, allBets*/ 524372) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(129:2) {#if currStage === \\\"winners\\\"}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(139:2) {#if currStage === \\\"menu\\\"}",
    		ctx
    	});
    ...
    // (146:2) {#if nBet > 0 && currStage !== "draw"}
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*click_handler_4*/ ctx[18], { once: true }, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(146:2) {#if nBet > 0 && currStage !== \\\"draw\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*showModal*/ ctx[0] && create_if_block_9(ctx);
    	let if_block1 = /*currStage*/ ctx[5] === "menu" && create_if_block_8(ctx);
    	let if_block2 = /*currStage*/ ctx[5] === "bet" && create_if_block_7(ctx);
    	let if_block3 = /*currStage*/ ctx[5] === "manual" && create_if_block_6(ctx);
    	let if_block4 = /*currStage*/ ctx[5] === "betDone" && create_if_block_5(ctx);
    	let if_block5 = /*currStage*/ ctx[5] === "draw" && create_if_block_4(ctx);
    	let if_block6 = /*currStage*/ ctx[5] === "winners" && create_if_block_3(ctx);
    	let if_block7 = /*currStage*/ ctx[5] === "menu" && create_if_block_2(ctx);
    	let if_block8 = /*currStage*/ ctx[5] === "bet" && create_if_block_1(ctx);
    	let if_block9 = /*nBet*/ ctx[3] > 0 && /*currStage*/ ctx[5] !== "draw" && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*darkMode*/ 64) set_data_dev(t8, /*darkMode*/ ctx[6]);
