...
var app = (function () {
    ...
    /* src\Box.svelte generated by Svelte v3.59.2 */

    const file$4 = "src\\Box.svelte";
    ...
    /* src\AddBet.svelte generated by Svelte v3.59.2 */
    const file$3 = "src\\AddBet.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input1, file$3, 26, 4, 616);
    			add_location(br1, file$3, 26, 122, 734);
    			add_location(label, file$3, 28, 4, 806);
    			option0.__value = "auto";
    			option0.value = option0.__value;
    			add_location(option0, file$3, 30, 8, 903);
    			option1.__value = "manual";
    			option1.value = option1.__value;
    			add_location(option1, file$3, 31, 8, 960);
    			...
    			add_location(select, file$3, 29, 4, 842);
    			attr_dev(hr, "class", "svelte-15o6ydo");
    			add_location(hr, file$3, 33, 4, 1026);
    			attr_dev(button, "class", "svelte-15o6ydo");
    			toggle_class(button, "dark", /*darkMode*/ ctx[0]);
    			add_location(button, file$3, 34, 4, 1036);
    			add_location(form, file$3, 23, 0, 441);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class AddBet extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { darkMode: 0, generalId: 5 });
    ...
    /* src\ManualBet.svelte generated by Svelte v3.59.2 */

    const { console: console_1$1 } = globals;
    const file$2 = "src\\ManualBet.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 44, 4, 1077);
    			...
    			input0.required = true;
    			toggle_class(input0, "dark", /*darkMode*/ ctx[0]);
    			add_location(input0, file$2, 49, 8, 1263);
    			attr_dev(input1, "type", "number");
    			...
    			input1.required = true;
    			toggle_class(input1, "dark", /*darkMode*/ ctx[0]);
    			add_location(input1, file$2, 50, 8, 1386);
    			...
    			add_location(input2, file$2, 51, 8, 1509);
    			...
    			add_location(input3, file$2, 52, 8, 1632);
    			...
    			add_location(input4, file$2, 53, 8, 1755);
    			attr_dev(div, "class", "grid svelte-14lmu5h");
    			add_location(div, file$2, 48, 4, 1235);
    			attr_dev(button, "class", "svelte-14lmu5h");
    			toggle_class(button, "dark", /*darkMode*/ ctx[0]);
    			add_location(button, file$2, 56, 4, 1888);
    			add_location(form, file$2, 43, 0, 1025);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 7, 4, 255);
    			add_location(h2, file$1, 8, 4, 288);
    			add_location(hr, file$1, 10, 4, 319);
    			...
    			add_location(textarea, file$1, 13, 8, 359);
    			attr_dev(div0, "class", "text svelte-13wl3t9");
    			add_location(div0, file$1, 12, 4, 331);
    			attr_dev(div1, "class", "box svelte-13wl3t9");
    			add_location(div1, file$1, 6, 0, 232);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const box_changes = {};
    			if (dirty & /*darkMode*/ 4) box_changes.darkMode = /*darkMode*/ ctx[2];

    			if (dirty & /*$$scope, darkMode*/ 2052) {
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const menu_changes = {};
    			if (dirty & /*darkMode*/ 4) menu_changes.darkMode = /*darkMode*/ ctx[2];
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, generalId*/ 2053) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*darkMode*/ 4) addbet_changes.darkMode = /*darkMode*/ ctx[2];
    ...
    function create_if_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(70:2) {#if currStage === \\\"manual\\\"}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	manualbet.$on("manualBet", /*manualBet*/ ctx[5]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*darkMode*/ 4) manualbet_changes.darkMode = /*darkMode*/ ctx[2];
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, currStage*/ 2054) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(76:2) {#if currStage === \\\"betDone\\\"}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 77, 4, 1362);
    			attr_dev(button, "class", "svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[2]);
    			add_location(button, file, 78, 4, 1393);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[2]);
    			add_location(button, file, 86, 3, 1652);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[2]);
    			add_location(button, file, 89, 3, 1779);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*currStage*/ ctx[1] === "menu" && create_if_block_5(ctx);
    	let if_block1 = /*currStage*/ ctx[1] === "bet" && create_if_block_4(ctx);
    	let if_block2 = /*currStage*/ ctx[1] === "manual" && create_if_block_3(ctx);
    	let if_block3 = /*currStage*/ ctx[1] === "betDone" && create_if_block_2(ctx);
    	let if_block4 = /*currStage*/ ctx[1] === "menu" && create_if_block_1(ctx);
    	let if_block5 = /*currStage*/ ctx[1] === "bet" && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			button = element("button");
    			t4 = text("Dark Mode: ");
    			t5 = text(/*darkMode*/ ctx[2]);
    			t6 = space();
    			if (if_block4) if_block4.c();
    			t7 = space();
    			if (if_block5) if_block5.c();
    			attr_dev(div0, "class", "mainDiv svelte-jtoyal");
    			add_location(div0, file, 56, 1, 935);
    			attr_dev(button, "class", "darkButton svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[2]);
    			add_location(button, file, 84, 2, 1514);
    			add_location(div1, file, 83, 1, 1506);
    			attr_dev(main, "class", "backGround svelte-jtoyal");
    			toggle_class(main, "dark", /*darkMode*/ ctx[2]);
    			add_location(main, file, 55, 0, 886);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*handleDarkMode*/ ctx[3], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (/*currStage*/ ctx[1] === "menu") {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty & /*currStage*/ 2) {
    			...
    			if (!current || dirty & /*darkMode*/ 4) set_data_dev(t5, /*darkMode*/ ctx[2]);

    			if (!current || dirty & /*darkMode*/ 4) {
    				toggle_class(button, "dark", /*darkMode*/ ctx[2]);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const addBet = e => {
    		...
    		if (e.detail.betType == "auto") {
    			...
    			$$invalidate(1, currStage = "betDone");
    			$$invalidate(0, generalId++, generalId);
    			console.log(allBets);
    		} else {
    			$$invalidate(1, currStage = "manual");
    		}
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('allBets' in $$props) allBets = $$props.allBets;
    		if ('currStage' in $$props) $$invalidate(1, currStage = $$props.currStage);
