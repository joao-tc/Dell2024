...
var app = (function () {
    ...
    const file$7 = "src\\Component\\Box.svelte";
    ...
    const file$6 = "src\\Stages\\AddBet.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input1, file$6, 26, 4, 616);
    			add_location(br1, file$6, 26, 122, 734);
    			add_location(label, file$6, 28, 4, 806);
    			option0.__value = "auto";
    			option0.value = option0.__value;
    			add_location(option0, file$6, 30, 8, 903);
    			option1.__value = "manual";
    			option1.value = option1.__value;
    			add_location(option1, file$6, 31, 8, 960);
    			...
    			add_location(select, file$6, 29, 4, 842);
    			attr_dev(hr, "class", "svelte-185ai4");
    			add_location(hr, file$6, 33, 4, 1026);
    			attr_dev(button, "class", "svelte-185ai4");
    			toggle_class(button, "dark", /*darkMode*/ ctx[0]);
    			add_location(button, file$6, 34, 4, 1036);
    			add_location(form, file$6, 23, 0, 441);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class AddBet extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { darkMode: 0, generalId: 5 });
    ...
    const file$5 = "src\\Stages\\ManualBet.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$5, 40, 4, 997);
    			...
    			input0.required = true;
    			toggle_class(input0, "dark", /*darkMode*/ ctx[0]);
    			add_location(input0, file$5, 45, 8, 1183);
    			attr_dev(input1, "type", "number");
    			...
    			input1.required = true;
    			toggle_class(input1, "dark", /*darkMode*/ ctx[0]);
    			add_location(input1, file$5, 46, 8, 1306);
    			...
    			add_location(input2, file$5, 47, 8, 1429);
    			...
    			add_location(input3, file$5, 48, 8, 1552);
    			...
    			add_location(input4, file$5, 49, 8, 1675);
    			attr_dev(div, "class", "grid svelte-14lmu5h");
    			add_location(div, file$5, 44, 4, 1155);
    			attr_dev(button, "class", "svelte-14lmu5h");
    			toggle_class(button, "dark", /*darkMode*/ ctx[0]);
    			add_location(button, file$5, 52, 4, 1808);
    			add_location(form, file$5, 39, 0, 945);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src\\Stages\\Menu.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 7, 4, 255);
    			add_location(h2, file$4, 8, 4, 288);
    			add_location(hr, file$4, 10, 4, 319);
    			...
    			add_location(textarea, file$4, 13, 8, 359);
    			attr_dev(div0, "class", "text svelte-13wl3t9");
    			add_location(div0, file$4, 12, 4, 331);
    			attr_dev(div1, "class", "box svelte-13wl3t9");
    			add_location(div1, file$4, 6, 0, 232);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src\\Stages\\StartDraw.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$3, 83, 4, 1888);
    			attr_dev(h30, "class", "svelte-mnsa5");
    			add_location(h30, file$3, 84, 4, 1921);
    			add_location(hr0, file$3, 86, 4, 1949);
    			attr_dev(h21, "class", "svelte-mnsa5");
    			add_location(h21, file$3, 88, 4, 1961);
    			attr_dev(h31, "class", "svelte-mnsa5");
    			add_location(h31, file$3, 89, 4, 1992);
    			add_location(hr1, file$3, 91, 4, 2015);
    			attr_dev(h22, "class", "svelte-mnsa5");
    			add_location(h22, file$3, 93, 4, 2027);
    			attr_dev(h32, "class", "svelte-mnsa5");
    			add_location(h32, file$3, 94, 4, 2057);
    			add_location(hr2, file$3, 96, 4, 2098);
    			attr_dev(button, "class", "svelte-mnsa5");
    			toggle_class(button, "dark", /*darkMode*/ ctx[1]);
    			add_location(button, file$3, 98, 4, 2110);
    			add_location(div, file$3, 82, 0, 1877);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src\\Component\\Modal.svelte";
    ...
    const file$1 = "src\\AddGhost.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 17, 8, 325);
    			...
    			add_location(input, file$1, 18, 8, 372);
    			add_location(button, file$1, 19, 8, 489);
    			add_location(form, file$1, 16, 4, 269);
    ...
    function create_if_block_8(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const modal_changes = {};
    			if (dirty & /*darkMode*/ 32) modal_changes.darkMode = /*darkMode*/ ctx[5];

    			if (dirty & /*$$scope, darkMode*/ 262176) {
    ...
    function create_default_slot_5(ctx) {
    	...
    	addghost = new AddGhost({
    			props: { darkMode: /*darkMode*/ ctx[5] },
    			$$inline: true
    		});

    	addghost.$on("addGhost", /*addGhost*/ ctx[12]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*darkMode*/ 32) addghost_changes.darkMode = /*darkMode*/ ctx[5];
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const box_changes = {};
    			if (dirty & /*darkMode*/ 32) box_changes.darkMode = /*darkMode*/ ctx[5];
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const menu_changes = {};
    			if (dirty & /*darkMode*/ 32) menu_changes.darkMode = /*darkMode*/ ctx[5];
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, generalId*/ 262178) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*darkMode*/ 32) addbet_changes.darkMode = /*darkMode*/ ctx[5];
    ...
    function create_if_block_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(107:2) {#if currStage === \\\"manual\\\"}",
    		ctx
    	});
    ...
    function create_default_slot_2(ctx) {
    	...
    	manualbet.$on("manualBet", /*manualBet*/ ctx[10]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*darkMode*/ 32) manualbet_changes.darkMode = /*darkMode*/ ctx[5];
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, currStage*/ 262192) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(113:2) {#if currStage === \\\"betDone\\\"}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 114, 4, 2076);
    			attr_dev(button, "class", "svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[5]);
    			add_location(button, file, 115, 4, 2107);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, darkMode, allBets, nBet*/ 262188) {
    				box_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(120:2) {#if currStage === \\\"draw\\\"}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	startdraw = new StartDraw({
    			props: {
    				...
    				nBet: /*nBet*/ ctx[3],
    				draw: /*newRandomBet*/ ctx[7]()
    			},
    			$$inline: true
    		});

    	startdraw.$on("winnersList", /*handleWinners*/ ctx[11]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*darkMode*/ 32) startdraw_changes.darkMode = /*darkMode*/ ctx[5];
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[5]);
    			add_location(button, file, 130, 3, 2543);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(130:2) {#if currStage === \\\"menu\\\"}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "svelte-jtoyal");
    			toggle_class(button0, "dark", /*darkMode*/ ctx[5]);
    			add_location(button0, file, 133, 3, 2670);
    			attr_dev(button1, "class", "svelte-jtoyal");
    			toggle_class(button1, "dark", /*darkMode*/ ctx[5]);
    			add_location(button1, file, 134, 3, 2761);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*click_handler_2*/ ctx[15], false, false, false, false),
    					listen_dev(button1, "click", /*click_handler_3*/ ctx[16], { once: true }, false, false, false)
    				];
    ...
    // (137:2) {#if nBet > 0 && currStage !== "draw"}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[5]);
    			add_location(button, file, 137, 3, 2920);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*click_handler_4*/ ctx[17], { once: true }, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(137:2) {#if nBet > 0 && currStage !== \\\"draw\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*showModal*/ ctx[0] && create_if_block_8(ctx);
    	let if_block1 = /*currStage*/ ctx[4] === "menu" && create_if_block_7(ctx);
    	let if_block2 = /*currStage*/ ctx[4] === "bet" && create_if_block_6(ctx);
    	let if_block3 = /*currStage*/ ctx[4] === "manual" && create_if_block_5(ctx);
    	let if_block4 = /*currStage*/ ctx[4] === "betDone" && create_if_block_4(ctx);
    	let if_block5 = /*currStage*/ ctx[4] === "draw" && create_if_block_3(ctx);
    	let if_block6 = /*currStage*/ ctx[4] === "menu" && create_if_block_2(ctx);
    	let if_block7 = /*currStage*/ ctx[4] === "bet" && create_if_block_1(ctx);
    	let if_block8 = /*nBet*/ ctx[3] > 0 && /*currStage*/ ctx[4] !== "draw" && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 93, 1, 1649);
    			attr_dev(button, "class", "darkButton svelte-jtoyal");
    			toggle_class(button, "dark", /*darkMode*/ ctx[5]);
    			add_location(button, file, 128, 2, 2405);
    			add_location(div1, file, 127, 1, 2397);
    			attr_dev(main, "class", "backGround svelte-jtoyal");
    			toggle_class(main, "dark", /*darkMode*/ ctx[5]);
    			add_location(main, file, 87, 0, 1495);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*handleDarkMode*/ ctx[8], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*currStage*/ ctx[4] === "menu") {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);

    					if (dirty & /*currStage*/ 16) {
    			...
    			if (!current || dirty & /*darkMode*/ 32) set_data_dev(t7, /*darkMode*/ ctx[5]);

    			if (!current || dirty & /*darkMode*/ 32) {
    				toggle_class(button, "dark", /*darkMode*/ ctx[5]);
    			}
    			...
    			if (/*nBet*/ ctx[3] > 0 && /*currStage*/ ctx[4] !== "draw") {
    				if (if_block8) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const handleDarkMode = () => {
    		$$invalidate(5, darkMode = !darkMode);
    	};
    	...
    	const addBet = e => {
    		...
    		if (e.detail.betType == "auto") {
    			...
    			$$invalidate(4, currStage = "betDone");
    			$$invalidate(1, generalId++, generalId);
    			$$invalidate(3, nBet++, nBet);
    		} else {
    			$$invalidate(4, currStage = "manual");
    		}
    	};
    	...
    	const handleWinners = e => {
    		$$invalidate(4, currStage = "winners");
    		$$invalidate(3, nBet = 0);
    	};
    	...
    	const click_handler_2 = () => {
    		$$invalidate(4, currStage = "menu");
    	};

    	const click_handler_3 = () => $$invalidate(0, showModal = true);

    	const click_handler_4 = () => {
    		$$invalidate(4, currStage = "draw");
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('prize' in $$props) $$invalidate(6, prize = $$props.prize);
    		if ('currStage' in $$props) $$invalidate(4, currStage = $$props.currStage);
    		if ('darkMode' in $$props) $$invalidate(5, darkMode = $$props.darkMode);
    	};
